...
'TEMP' => 'Temperatura',
'WIND CHILL' => 'Viento helado',
'HEAT INDEX' => 'Indice de calor',
'WIND' => 'Viento',
'DEWPT' => 'Punto de rocio',
'HUMIDITY' => 'Humedad',
'BAROMETER' => 'Barometro',
'CONDITIONS' => 'Resumen',
'CLOUDS' => 'Nubes',
'VISIBILITY' => 'Visibilidad',
'CLOUD-DETAILS' => 'Detalle de nubes',
);
...
<table width="380" cellpadding="2" cellspacing="1">
  <!--<tr>
    <td colspan="2" class="datahead" style="text-align: center;border: none">
    <?php /* echo "$mtrICAO - $mtrName"; 
	 if($mtrDistanceM <> '' and $mtrDistanceK <> '') {
		 echo "".langtransstr('Distancia a la estaci&oacute;n').": ";
		 if($direction <> '') {
			 echo " ".langtransstr($direction). " ";
		 }
		 if(isset($SITE['uomDistance']) and preg_match('|i',$SITE['uomDistance'])) {
    ...
    <td align="center" valign="top" class="data1" style="text-align: center;border: none">
          <img src="<?php echo $condIconDir . newIcon($iconnum) ?>"  
            alt="<?php $t1 = fixupCondition($condwords);
                  echo $t1; ?>" 
            title="<?php echo $t1; ?>" height="78" width="75" /><br/>
          <b style="font-size: 15px;"><?php echo $t1; ?></b>
    </td>
    <td align="center" valign="top" class="data1" style="text-align: center;border: none">
