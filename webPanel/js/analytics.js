...
var inBackgroundPage = window.chrome && chrome.extension && chrome.extension.getBackgroundPage && chrome.extension.getBackgroundPage() && chrome.extension.getBackgroundPage().location.href.indexOf(pageUrl) != -1;
var inPopupPage = pageUrl && pageUrl.indexOf("popup.") != -1;
